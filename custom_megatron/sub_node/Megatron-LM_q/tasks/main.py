...
def get_tasks_args(parser):
    ...
    # JK
    group.add_argument('--bits', type=int, default=8,
                       help='Size of Bits to quantize')
    group.add_argument('--quantize_forward', action='store_true',
                       help='Whether quantize forward')
    group.add_argument('--quantize_backward', action='store_true',
                       help='Whether quantize backward')
...
if __name__ == '__main__':
    ...
    elif args.task in ['MNLI', 'QQP', 'MRPC']:
