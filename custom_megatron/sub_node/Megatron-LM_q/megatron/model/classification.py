...
from megatron.quantization_utils.quant_modules import *
...
class Classification(MegatronModule):
    ...
    def __init__(self,
        ...
        # JK
        self.quantization = QuantAct(activation_bit=args.bits)
        self.quantization_backward = QuantAct(activation_bit=args.bits)
        # Multi-choice head.
